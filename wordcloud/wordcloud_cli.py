...
Usage::
    ...
    $ wordcloud_cli.py --word_list=[('test1': 10), ('test2': 12)] --stopwords=stopwords.txt
"""
import argparse
...
def main(args):
    wordcloud = wc.WordCloud(stopwords=args.stopwords, mask=args.mask,
                             ...
                             words_list=args.word_list).generate(args.text)
...
def parse_args(arguments):
    ...
    parser.add_argument('--word_list', type=list, default=None,
                        metavar='height', help='List of words/frequencies provided instead of analysing custom text.')
